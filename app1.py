...
def price_prediction(trip_miles, trip_time, pickup_hour, pickup_day, trip_duration):
    print('Entered the price pred function')
    data = {
...
def main():
    ...
    trip_duration = st.number_input("Enter trip duration", min_value=0.0)
    ...
    if st.button("Predict"):
        result=price_prediction(trip_miles, trip_time, pickup_hour, pickup_day, trip_duration)
